...
// a separate root for DataHelper::ReadSquareAndCountry
trash : (BULLET | OTHER | COMMA);
squareAndCountry: 
          (trash* square COMMA?  COUNTRY?)
        | (trash* square_value COMMA?  COUNTRY?)
