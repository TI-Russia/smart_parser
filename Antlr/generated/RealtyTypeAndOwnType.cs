...
public partial class RealtyTypeAndOwnType : Parser {
	...
	public partial class Realty_listContext : ParserRuleContext {
		...
		public ITerminalNode[] HYPHEN() { return GetTokens(RealtyTypeAndOwnType.HYPHEN); }
		public ITerminalNode HYPHEN(int i) {
			return GetToken(RealtyTypeAndOwnType.HYPHEN, i);
		}
		public ITerminalNode[] SEMICOLON() { return GetTokens(RealtyTypeAndOwnType.SEMICOLON); }
	...
	public partial class RealtyContext : ParserRuleContext {
		...
		public ITerminalNode COMMA() { return GetToken(RealtyTypeAndOwnType.COMMA, 0); }
		public ITerminalNode OPN_BRK() { return GetToken(RealtyTypeAndOwnType.OPN_BRK, 0); }
		public Own_typeContext own_type() {
			return GetRuleContext<Own_typeContext>(0);
		}
		public ITerminalNode CLS_BRK() { return GetToken(RealtyTypeAndOwnType.CLS_BRK, 0); }
		public Realty_shareContext realty_share() {
			return GetRuleContext<Realty_shareContext>(0);
		}
		public ITerminalNode DOLYA_WORD() { return GetToken(RealtyTypeAndOwnType.DOLYA_WORD, 0); }
	...
	public partial class Realty_idContext : ParserRuleContext {
		public IToken _INT;
		public ITerminalNode INT() { return GetToken(RealtyTypeAndOwnType.INT, 0); }
	...
	public Realty_idContext realty_id() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 59; _localctx._INT = Match(INT);
			State = 60;
	...
	public partial class Square_value_without_spacesContext : ParserRuleContext {
		public IToken _INT;
		public ITerminalNode FLOATING() { return GetToken(RealtyTypeAndOwnType.FLOATING, 0); }
		public ITerminalNode INT() { return GetToken(RealtyTypeAndOwnType.INT, 0); }
	...
	public Square_value_without_spacesContext square_value_without_spaces() {
		...
		try {
			...
			case FLOATING:
				EnterOuterAlt(_localctx, 1);
				{
				State = 62; Match(FLOATING);
				}
				break;
			case INT:
				EnterOuterAlt(_localctx, 2);
				{
				State = 63; _localctx._INT = Match(INT);
				State = 64;
				if (!((_localctx._INT!=null?int.Parse(_localctx._INT.Text):0) < 6000000)) throw new FailedPredicateException(this, "$INT.int < 6000000");
				}
				break;
	...
	public partial class Square_value_with_spacesContext : ParserRuleContext {
		public IToken _INT;
		public ITerminalNode[] INT() { return GetTokens(RealtyTypeAndOwnType.INT); }
	...
	public Square_value_with_spacesContext square_value_with_spaces() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 67; _localctx._INT = Match(INT);
			State = 69;
			ErrorHandler.Sync(this);
			switch ( Interpreter.AdaptivePredict(TokenStream,12,Context) ) {
			case 1:
				{
				State = 68; _localctx._INT = Match(INT);
				}
				break;
			}
			State = 71;
	...
	public Square_valueContext square_value() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 74; square_value_without_spaces();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 75; square_value_with_spaces();
				}
				break;
			}
		}
	...
	public partial class Own_typeContext : ParserRuleContext {
		public ITerminalNode OWN_TYPE() { return GetToken(RealtyTypeAndOwnType.OWN_TYPE, 0); }
		public Realty_shareContext realty_share() {
			return GetRuleContext<Realty_shareContext>(0);
		}
		public ITerminalNode[] DOLYA_WORD() { return GetTokens(RealtyTypeAndOwnType.DOLYA_WORD); }
		public ITerminalNode DOLYA_WORD(int i) {
			return GetToken(RealtyTypeAndOwnType.DOLYA_WORD, i);
		}
		public ITerminalNode COMMA() { return GetToken(RealtyTypeAndOwnType.COMMA, 0); }
		public ITerminalNode OT() { return GetToken(RealtyTypeAndOwnType.OT, 0); }
	...
	public Own_typeContext own_type() {
		...
		try {
			...
			case 2:
				...
				{
				{
				State = 79; Match(OWN_TYPE);
				State = 81;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==DOLYA_WORD) {
					{
					State = 80; Match(DOLYA_WORD);
					}
				}
				...
				State = 86; realty_share();
				State = 88;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==DOLYA_WORD) {
					{
					State = 87; Match(DOLYA_WORD);
					}
				}
	...
	public partial class Realty_shareContext : ParserRuleContext {
		public ITerminalNode FRACTION_UNICODE() { return GetToken(RealtyTypeAndOwnType.FRACTION_UNICODE, 0); }
		public ITerminalNode FRACTION_ASCII() { return GetToken(RealtyTypeAndOwnType.FRACTION_ASCII, 0); }
	...
	public partial class SquareContext : ParserRuleContext {
		...
		public ITerminalNode SQUARE_METER() { return GetToken(RealtyTypeAndOwnType.SQUARE_METER, 0); }
		public ITerminalNode HECTARE() { return GetToken(RealtyTypeAndOwnType.HECTARE, 0); }
	...
	public partial class Realty_typeContext : ParserRuleContext {
		public ITerminalNode REALTY_TYPE() { return GetToken(RealtyTypeAndOwnType.REALTY_TYPE, 0); }
	...
	public partial class CountryContext : ParserRuleContext {
		public ITerminalNode COUNTRY() { return GetToken(RealtyTypeAndOwnType.COUNTRY, 0); }
