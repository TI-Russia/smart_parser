...
namespace TI.Declarator.ParserCommon
{
    public class TStringMeasure
    {
        ...
        static Dictionary<int, int> CurrentAppoximatedTable = null;
        ...
        {
            return DefaultFont != null  || CurrentAppoximatedTable != null;
        }
        static public void InitDefaultFontApproximated(string fontName, int fontSize)
        {
            if (fontName == "Arial") {
                CurrentAppoximatedTable = Arial;
            } else if (fontName == "Calibri")
            {
                CurrentAppoximatedTable = Calibri;
            } else
            {
                CurrentAppoximatedTable = Times_New_Roman;
            }
            FontSize = fontSize;
        }
        static public void InitDefaultFontSystem(string fontName, int fontSize)
        {
            CurrentAppoximatedTable = null;
            FontSize = fontSize;
            FontName = fontName;
            if (fontSize > 0)
            {
        ...
        {
            s = s.Replace(' ', '_');
            if (CurrentAppoximatedTable != null)
            {
                return StringWidthApproximated(CurrentAppoximatedTable, s);
            }
