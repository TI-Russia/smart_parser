...
python3 ~/smart_parser/tools/predict_office/scripts/prepare_train_pool.py --pool ~/tmp/predict_office/train.declarator.txt  ~/smart_parser/tools/predict_office/pools/train.sud.txt  ~/smart_parser/tools/predict_office/pools/train.toloka.txt,3  ~/smart_parser/tools/predict_office/pools/weak_offices_pool.txt --output-train-pool train_pool.txt
