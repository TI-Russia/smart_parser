...
python3 download_all_documents.py --table declarations_document --output-folder out.documentfile --prefix d
python3 download_all_documents.py --table declarations_documentfile --output-folder out.documentfile
