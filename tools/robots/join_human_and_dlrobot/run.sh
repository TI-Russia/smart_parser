...
python $TOOLS_FOLDER/create_json_by_human_files.py --folder $ALL_HUMAN_FILES_FOLDER --table declarations_documentfile --output-json human_files.json
...
#create dlrobot db
python $TOOLS_FOLDER/create_dlrobotdb.py --smart-parser-human-json-folder human_smart_parser_jsons  --dlrobot-human dlrobot_human.json >create_dlrobotdb.log
