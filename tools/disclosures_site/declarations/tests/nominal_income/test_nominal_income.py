...
class NominalIncome(TestCase):
    ...
    def test_nominal_income(self):
        # out of year scope
        self.assertIsNone(TRussia.get_average_nominal_incomes([YearIncome(2008, 1), YearIncome(2009, 2)]))

        # one year is not enough
        self.assertIsNone(TRussia.get_average_nominal_incomes([YearIncome(2015,1)]))

        # two years
        comp = TRussia.get_average_nominal_incomes([YearIncome(2015, 1000000), YearIncome(2016, 2000000)])
        ...
        # 3 years
        comp = TRussia.get_average_nominal_incomes([YearIncome(2015, 1000000), YearIncome(2016, 1500000), YearIncome(2017, 2000000)])
        self.assertEqual(comp.declarant_income, 100) # 100% growth
        ...
        comp = TRussia.get_average_nominal_incomes([YearIncome(1990, 100000000), YearIncome(2015, 1000000),
        ...
        comp = TRussia.get_average_nominal_incomes([YearIncome(2015, 0), YearIncome(2016, 1500000), YearIncome(2017, 2000000)])
        ...
        comp = TRussia.get_average_nominal_incomes(incomes)
