...
class NominalIncome(TestCase):
    ...
    def test_nominal_income(self):
        ...
        comp = get_average_nominal_incomes([YearIncome(2000, 100000000), YearIncome(2015, 1000000),
        ...
        self.assertAlmostEqual(comp.population_income, 35, places=3)
        ...
        self.assertAlmostEqual(comp.population_income, 51   , places=3)
        ...
        self.assertAlmostEqual(comp.population_income, 33, places=3)
        self.assertEqual(comp.min_year, 2012)
        self.assertEqual(comp.max_year, 2016)
