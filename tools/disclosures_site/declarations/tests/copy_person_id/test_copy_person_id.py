...
def build_declarator_squeeze(document_id, mapping_value, fio, income_main1, income_main2, use_only_surname,
                             person_ids_path):
    with open(person_ids_path, "w") as outp:
        ...
        record = {
            build_section_passport(document_id, fio_key, income_main1): mapping_value,
            build_section_passport(document_id, fio_key, income_main2): mapping_value,
        }
...
class CopyPersonIdTestCaseBase(TestCase):
    ...
    def run_copy_person_id(self, use_only_surname, check_ambiguity, declarator_person_id=None):
        ...
        build_declarator_squeeze(document_id, mapping_value, fio, income_main1, income_main2, use_only_surname,
                                 person_ids_path)
        ...
        section1 = models.Section(id=self.section_id1, source_document=src_doc, person_name=fio)
        section1.save()
