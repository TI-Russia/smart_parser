...
python3 ~/smart_parser/tools/disclosures_site/scripts/predict_office/prepare_train_pool.py --pool $TRAIN_DECLARATOR  ~/smart_parser/tools/disclosures_site/predict_office/pools/train.sud.txt  ~/smart_parser/tools/disclosures_site/predict_office/pools/train.toloka.txt,3  --output-train-pool train_pool.txt
