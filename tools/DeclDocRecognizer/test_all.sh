...
if [ "$(expr substr $(uname -s) 1 5)" == "Linux" ]; then
    export DECL_DOC_RECOGNIZER_TESTS_FOLDER=/mnt/ntfs/Sokirko/test_files/DeclDocRecognizer
else
   export DECL_DOC_RECOGNIZER_TESTS_FOLDER=C:/Sokirko/test_files/DeclDocRecognizer
fi
