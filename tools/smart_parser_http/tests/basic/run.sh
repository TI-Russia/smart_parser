...
not_found=`python3 ../../smart_parser_client.py --action get MainWorkPositionIncome.docx`
...
python3 ../../smart_parser_client.py --action get MainWorkPositionIncome.docx > res.json
