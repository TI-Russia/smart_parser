...
BAD_LINKS = [
    ...
    ("www.mvd.ru", "www.mvd.ru/test.html?print=1", True),
    ...
    ("http://www.admkrsk.ru/Pages/default.aspx", "http://www.admkrsk.ru/city/areas/kir/Pages/incomes.aspx?accessability=on&spacing=3", True),
]
