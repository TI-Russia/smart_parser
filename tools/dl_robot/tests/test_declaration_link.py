...
class TestDeclarationLink(TestDeclarationLinkBase):
    ...
    def test_page_text(self):
        links = self.process_one_page_wrapper("web_sites/page_text/sved.html")
    ...
    def test_other_website(self):
        ...
        links = self.process_one_page_wrapper("web_sites/other_website/sved.html")
    ...
    def test_simple_doc(self):
        links = self.process_one_page_wrapper("web_sites/simple_doc/sved.html")
    ...
    def test_rosminzdrav(self):
        links = self.process_one_page_wrapper("web_sites/minzdrav/6_4_2.html")
        #self.canonize_links(links, 'web_sites/minzdrav/found_links')
        self.compare_to_file(links, 'web_sites/minzdrav/found_links')

    def test_zsro(self):
        links = self.process_one_page_wrapper("web_sites/zsro/sved.html")
    ...
    def test_khabkrai(self):
        links = self.process_one_page_wrapper("web_sites/khabkrai/sved.html")
